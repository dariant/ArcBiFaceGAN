...
class StyleGAN2Loss(Loss):
    def __init__(self, device, G_mapping, G_synthesis, D, D_NIR, augment_pipe=None, style_mixing_prob=0.9, 
                 r1_gamma=10, pl_batch_shrink=2, pl_decay=0.01, pl_weight=2, TRAIN_IMAGE_OR_NIR_OR_MASK = "image", nir_loss_weight = 1.0):
        super().__init__()
        self.device = device
        ...
        self.D_NIR = D_NIR
        self.nir_loss_weight = nir_loss_weight
        ...
        if self.TRAIN_IMAGE_OR_NIR_OR_MASK == "NIR":
            ...
            if do_Gmain:
                ...
                with torch.autograd.profiler.record_function('Gmain_forward'):
                    ...
                    #print("NIR Loss weight", self.nir_loss_weight)
                    loss_Gmain = loss_Gmain + self.nir_loss_weight * loss_Gmain_NIR # TODO weighted loss here
                    training_stats.report('Loss/G/loss', loss_Gmain)
            ...
            if do_D_NIR_main:
                ...
                with torch.autograd.profiler.record_function('Dgen_forward_NIR'):
                    ...
                    training_stats.report('Loss/scores/fake_NIR', gen_logits_NIR)
                    training_stats.report('Loss/signs/fake_NIR', gen_logits_NIR.sign())
