...
from . import metric_utils_as_class as metric_utils
from . import frechet_inception_distance_as_class as frechet_inception_distance
...
def fid10k_full(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid, fid_NIR = frechet_inception_distance.compute_fid(opts, max_real=None, num_gen=10000)
    return dict(fid10k_full=fid, fid10k_full_NIR=fid_NIR)
